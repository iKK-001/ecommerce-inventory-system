...
Route::put('/weekly-sales/variants/{variant}/costs', [WeeklySalesController::class, 'updateVariantCosts'])->name('weekly-sales.variant-costs.update')->middleware('permission:edit_products');
